<form id ="form" class="" action='{{route("admin.bod.add")}}' method="post" enctype="multipart/form-data">
  <!-- @csrf -->
  ...
  <div class="mb-3 col-md-12">
    ...
    <div class="mt-3">
      <img id="preview-img" src="{{$data == null ? '#' : asset('images/bod'.$data->image_name.'')}}" alt="your image" style="width:100%" onerror="this.style.display='none'"/>
    </div>
  </div>
  <div class="mb-3">
