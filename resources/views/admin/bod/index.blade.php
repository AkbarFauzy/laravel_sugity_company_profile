      ...
      <div class="content-header row p-1 mb-4">
        <div class="col">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Board of Directors</h2>
                </div>
            </div>
        </div>
        <div class="col">
            ...
            class="btn btn-success btn-md text-white">Create Board of Directors</a>
        </div>
    </div>
    <hr>
...
$(function() {
    ...
    $(document).ready(function(){
      ...
      let dialog = bootbox.dialog({
        title:'Create New Board of Director',
      ...
      dialog.init(function(e){
        ...
        req.open("GET", '{{route("admin.bod.form")}}', true);
        req.send();
      });
      ...
      let id = $(this).data('id');
        dialog = bootbox.dialog({
          title: "Update Board of Director with ID#"+id,
          message: '<center><div class="preloader"><div class="spinner-layer pl-red"><div class="circle-clipper left"><div class="circle"></div></div><div class="circle-clipper right"><div class="circle"></div></div></div></div></center>',
        })
        dialog.init(function(e){
          let req = new XMLHttpRequest();
          ...
          req.open("GET", '{{route("admin.bod.form.edit",'')}}/'+id, true);
          req.send();
        })
